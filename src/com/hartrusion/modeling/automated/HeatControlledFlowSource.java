 ...
 */
public class HeatControlledFlowSource implements Runnable, ValueProvider,
    ...
    public AbstractAC getState() {
        ...
        vm.setOpening(value.getOutput());
        vm.setTargetOpening(value.getInput());
        return vm;
    }

    @Override
    public void setAutomationCondition(AbstractAC ac) {
        value.setInput(((ValveManual) ac).getTargetOpening());
        value.forceOutputValue(((ValveManual) ac).getOpening());
    }
